...
```{r, out.width = "600px", echo=FALSE, fig.align='center',fig.cap="Prediction Error vs. Model Complexity[^1]"}
knitr::include_graphics("./Images/PredErrorVsModelComplexity.png")  
```
...
```{r, out.width = "400px", echo=FALSE, fig.align='center',fig.cap="Validation Set Approach[^1]"}
knitr::include_graphics("./Images/ValidationSetApproach.png")  
```
...
```{r, out.width = "400px", echo=FALSE, fig.align='center',fig.cap="LOOCV[^1]"}
knitr::include_graphics("./Images/loocv.png")
```
...
```{r, out.width = "400px", echo=FALSE, fig.align='center',fig.cap="k-fold cross estimation[^1]"}
knitr::include_graphics("./Images/k fold cross validation.png")
```
