...
```{r, out.width = "600px", echo=FALSE, fig.align='center',fig.cap="Interpretability vs Prediction Accuracy"}
knitr::include_graphics("./Images/InterpretabilityVsAccuracy.png")  
```
...
```{r, out.width = "600px", echo=FALSE, fig.align='center',fig.cap="Bias and Variance"}
